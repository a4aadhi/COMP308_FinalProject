...
export default function PatientModal({ PatientModalProps }) {
  ...
  size="lg"
>
  <Modal.Header closeButton style={{ backgroundColor: '#d3eafd' }}>
    <Modal.Title id="contained-modal-title-vcenter">
      <h2 className="text-center">
        <Badge bg="success">Vital Signs History</Badge>

      </h2>
    </Modal.Title>
  </Modal.Header>
  <Modal.Body className="show-grid" style={{ backgroundColor: '#f0f8ff' }}>
    <Container>
      <MDBRow>
        <MDBCol xl="8">
  ...
  <Modal.Footer style={{ backgroundColor: '#d3eafd' }}>
